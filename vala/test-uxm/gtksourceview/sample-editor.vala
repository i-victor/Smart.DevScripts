 ...
 *
 * Compile using gtksourceview3 or gtksourceview4:
 * valac sourceview.vala --pkg gtk+-3.0 --pkg gtksourceview-3.0
 * valac sourceview.vala --pkg gtk+-3.0 --pkg gtksourceview-4
 *
 * Author: Geronimo Bareiro https://github.com/gerito1
 * https://github.com/gerito1/vala-gtk-examples/blob/master/sourceview.vala
 */

public class SourceEditor : Gtk.Window {

	private const string TITLE = "Sample Source Code Editor";
	...
	//	source_view.background_pattern = GRID; // grid
