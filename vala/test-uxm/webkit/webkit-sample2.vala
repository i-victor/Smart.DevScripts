 ...
 *
 * modified by unixman:
 *  - added settings (disable plugins)
 *  - added context ignore TLS Errors (accept self signed certificates)
*/
...
public class MyWebkitWindow : Gtk.Window {
	...
	construct {
		...
		//-- fix by unixman
		var settings = this.web_view.get_settings();
		settings.enable_plugins = false;
		var context = this.web_view.get_context();
	...
	public static int main (string[] args) {
		...
		my_webkit_window.open_url ("https://127.0.0.1/sites/");
