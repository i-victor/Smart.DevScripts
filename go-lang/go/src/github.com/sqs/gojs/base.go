...
/*
#cgo linux pkg-config: javascriptcoregtk-4.0
#cgo openbsd CFLAGS: -I/usr/local/include/webkitgtk-4.0
#cgo openbsd LDFLAGS: -L/usr/local/lib -ljavascriptcoregtk-4.0 -Wl,-z,wxneeded
#include <stdlib.h>
