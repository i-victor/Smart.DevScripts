...
// CGO_LDFLAGS_ALLOW='-I/usr/local/include/SDL2 -I/usr/X11R6/include -D_REENTRANT -L/usr/local/lib -L/usr/X11R6/lib -lSDL2' go build gfx.go

/*
#cgo openbsd LDFLAGS: -I/usr/local/include/SDL2 -I/usr/X11R6/include -D_REENTRANT -L/usr/local/lib -L/usr/X11R6/lib -lSDL2
*/
